...
const BookingLaundry = ({ route }) => {
  ...
  const service = route?.params?.service || {
    name: 'Laundry',
    price: 'Mwk 15,000',
    description: 'Professional clothes cleaning to remove stains and refresh your clothes.',
    imageUrl: 'https://th.bing.com/th/id/OIP.m7J5201e5x78AE3i2UxgFQHaFr?w=233&h=180&c=7&r=0&o=5&dpr=1.1&pid=1.7',
  };
