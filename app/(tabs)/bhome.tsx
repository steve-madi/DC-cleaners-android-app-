...
const BookingHome = ({ route }) => {
  ...
  const service = route?.params?.service || {
    name: 'Home Cleaning',
    price: 'Mwk 50,000',
    description: 'Professional home cleaning to remove stains and refresh your House.',
    imageUrl: 'https://th.bing.com/th/id/OIP.4FSHDXzt4ofm6C9MFS1jRAHaE7?w=223&h=180&c=7&r=0&o=5&dpr=1.1&pid=1.7',
  };
