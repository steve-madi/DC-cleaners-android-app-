...
import { db } from './firebaseConfig'; // Ensure you have firebaseConfig.js file set up with your Firestore config
import { collection, addDoc } from 'firebase/firestore';

const BookingPipe = ({ route }) => {
  ...
  const service = route?.params?.service || {
    name: 'Pipe Cleaning',
    price: 'Mwk 25,000',
    description: 'Professional pipe cleaning to remove blockages.',
    imageUrl: 'https://th.bing.com/th/id/OIF.ehX3vr2Qy0IG9Z9kqVw9RA?w=272&h=180&c=7&r=0&o=5&dpr=1.1&pid=1.7',
  };
