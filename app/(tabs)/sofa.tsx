...
const BookingSofa = ({ route }) => {
  ...
  const service = route?.params?.service || {
    name: 'Sofa Cleaning',
    price: 'Mwk 40,000',
    description: 'Professional Sofa cleaning to remove stains and refresh your Sofa.',
    imageUrl: 'https://th.bing.com/th/id/OIP.vYN-KZcEfnZse-9_GcUMAgHaEK?w=296&h=180&c=7&r=0&o=5&dpr=1.1&pid=1.7',
  };
