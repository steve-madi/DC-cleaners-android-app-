...
const BookingCarpet = ({ route }) => {
  ...
  const service = route?.params?.service || {
    ...
    price: 'Mwk 30,000',
    description: 'Professional carpet cleaning to remove stains and refresh your carpets.',
    imageUrl: 'https://th.bing.com/th/id/OIF.kJLqZtFO0lxulWMwameBgQ?w=241&h=180&c=7&r=0&o=5&dpr=1.1&pid=1.7',
  };
