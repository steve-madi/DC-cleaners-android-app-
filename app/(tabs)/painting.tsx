...
const BookingPainting = ({ route }) => {
  ...
  const service = route?.params?.service || {
    name: 'House painting',
    price: 'Mwk 60,000',
    description: 'Professional house painting to make the house look good and clean.',
    imageUrl: 'https://th.bing.com/th/id/OIP._uIlYAzwdVnPhng_OjR7mwHaE7?w=247&h=180&c=7&r=0&o=5&dpr=1.1&pid=1.7',
  };
...
export default BookingPainting;
